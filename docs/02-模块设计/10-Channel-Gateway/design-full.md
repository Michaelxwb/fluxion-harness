...
| secret_ref | VARCHAR(512) | N |  |  | Bot Secret 引用 |
| agent_id | UUID | N |  | FK,IDX | 路由目标 Agent |
| enabled | BOOLEAN | N | TRUE | IDX | 是否连接/接收 |
| connection_metadata | JSONB | N | {} |  | corp/app 等非敏感信息 |
| last_connected_at | TIMESTAMPTZ | Y |  |  | 最近连接 |
...
| enabled | boolean | 状态 |
| connection_state | string | CONNECTED/DISCONNECTED/UNKNOWN |
| last_connected_at | datetime | 最近连接 |
...
```text
Agent scoped read channel_account(WECOM) → 连接状态来自 Gateway ephemeral registry/health 聚合；Secret 不返回。
```
...
|---|---|---|---|---|
| FEAT-CHAN-01 | CH-API-01, CH-API-02 | S-CHAN-01 | E2E/integration | 待实现/评审 |
| FEAT-CHAN-02 | CH-API-02, CH-API-03 | S-CHAN-02, E-CHAN-03 | E2E/integration | 待实现/评审 |
| FEAT-CHAN-03 | CH-API-03, CH-API-04 | S-CHAN-03, E-CHAN-01 | E2E/integration | 待实现/评审 |
| FEAT-CHAN-04 | CH-API-04, CH-API-05 | S-CHAN-04, E-CHAN-02 | E2E/integration | 待实现/评审 |
| FEAT-CHAN-05 | CH-API-05, CH-API-06 | S-CHAN-05 | E2E/integration | 待实现/评审 |
| FEAT-CHAN-06 | CH-API-06, CH-API-07 | 见 §2.5 | E2E/integration | 待实现/评审 |

## Spec Compliance Matrix

| Spec/Rule | enforcement | 设计影响 | 设计落点 | 验证场景 | 状态/N/A 理由 |
|---|---|---|---|---|---|
| DESIGN/CHAN#RULE-CHAN-01 | design-baseline | 约束实现与验收 | §2.5 RULE-CHAN-01 / §3 | S/E/B 场景 | applied；仓库 spec-context 待绑定 |
| DESIGN/CHAN#RULE-CHAN-02 | design-baseline | 约束实现与验收 | §2.5 RULE-CHAN-02 / §3 | S/E/B 场景 | applied；仓库 spec-context 待绑定 |
| DESIGN/CHAN#RULE-CHAN-03 | design-baseline | 约束实现与验收 | §2.5 RULE-CHAN-03 / §3 | S/E/B 场景 | applied；仓库 spec-context 待绑定 |
| DESIGN/CHAN#RULE-CHAN-04 | design-baseline | 约束实现与验收 | §2.5 RULE-CHAN-04 / §3 | S/E/B 场景 | applied；仓库 spec-context 待绑定 |
| DESIGN/CHAN#RULE-CHAN-05 | design-baseline | 约束实现与验收 | §2.5 RULE-CHAN-05 / §3 | S/E/B 场景 | applied；仓库 spec-context 待绑定 |
