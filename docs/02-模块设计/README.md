...
|---|---:|---:|---:|---|---|
| 18-用户与Agent授权 | Full | 2 | 10 | 用户/授权独立领域、DB、运行时权限校验 | `18-用户与Agent授权/design-full.md` |
| 05-Service与Execution | Full | 10 | 21 | Service Release、Execution Snapshot、状态生命周期 | `05-Service与Execution/design-full.md` |
| 11-Conversation与User-Memory | Full | 4 | 8 | 会话/消息/长期 Memory 持久化与隔离 | `11-Conversation与User-Memory/design-full.md` |
...
| 04-Agent-Core与Agent-Executor | Full | 4 | 11 | Agent Definition/Executor/Tool/Skill/Proposal 核心链路 | `04-Agent-Core与Agent-Executor/design-full.md` |
...
| 03-Agent-Runtime | Full | 0 | 3 | 无状态运行时、Chat Run 领取、上下文解析、横向扩展 | `03-Agent-Runtime/design-full.md` |
...
| 07-Capability-Runtime | Full | 2 | 12 | Capability Contract、多实现类型、自动分页/大结果 | `07-Capability-Runtime/design-full.md` |
...
| 09-Auth与项目平台 | Full | 3 | 13 | ProjectPlatform、用户凭据、Secret/Auth Resolver、内部与开发令牌 | `09-Auth与项目平台/design-full.md` |
| 12-Project-Integration与Registry | Full | 0 | 4 | 跨系统集成、Provider Registry、Manifest/Seed | `12-Project-Integration与Registry/design-full.md` |
...
| 05-Service与Execution | `execution_proposal`, `service_definition`, `service_release`, `execution_snapshot`, `service_execution`, `execution_step`, `async_task_run`, `execution_command`, `task_progress_event`, `artifact` |
| 11-Conversation与User-Memory | `conversation`, `message`, `channel_command_receipt`, `user_memory` |
...
| 08-Skill-Runtime | `skill_import_preview`, `skill_definition`, `skill_artifact`, `skill_artifact_capability`, `skill_artifact_validation_event` |
| 03-Agent-Runtime | 无独立表 |
| 17-Skill-SDK与离线开发 | 无独立表 |
| 10-Channel-Gateway | `channel_delivery`, `channel_account`, `channel_identity`, `channel_binding`, `bind_code`, `channel_delivery_route` |
| 06-Worker-Engine | `worker_slot_counter` |
| 19-模型配置与调用 | `model_config` |
| 07-Capability-Runtime | `capability_definition`, `capability_implementation` |
| 16-Knowledge规划 | 无独立表 |
| 15-可观测性与Web公共基础 | `audit_log` |
| 09-Auth与项目平台 | `project_platform`, `session_token`, `user_project_credential` |
...
- **写操作**：配置开发允许 Builder + Admin；项目平台、用户/授权、凭据、发布及执行控制仅 Admin。模型配置只有 `api_key` 为 Admin 专属写字段；`extra_headers` 已删除。精确字段权限以模块 09/19 的接口契约为准。
- **读操作**：Builder 读取配置所需的安全 DTO；凭据只返回 configured 状态。模型与项目平台的列表/详情投影以模块 09/19 为准，索引不另存一份字段白名单。
...
| 模块 | Owner 接口/函数 |
|---|---|
| 18-用户与Agent授权 | `USR-API-01`, `USR-API-02`, `USR-API-03`, `USR-API-04`, `USR-API-05`, `USR-API-06`, `USR-API-06R`, `USR-API-07`, `USR-LIB-01`, `USR-LIB-02` |
| 05-Service与Execution | `SVC-API-01`, `SVC-API-02`, `SVC-API-03`, `SVC-API-04`, `SVC-API-05`, `SVC-API-06`, `SVC-API-07`, `SVC-API-08`, `SVC-API-09`, `SVC-API-10`, `SVC-API-11`, `EXE-API-01`, `EXE-API-02`, `EXE-API-03`, `EXE-API-04`, `EXE-API-05`, `EXE-API-06`, `EXE-API-07`, `EXE-LIB-02`, `EXE-LIB-03`, `EXE-LIB-01` |
...
| 04-Agent-Core与Agent-Executor | `AGENT-API-01`, `AGENT-API-02`, `AGENT-API-03`, `AGENT-API-04`, `AGENT-API-05`, `AGENT-LIB-01`, `AGCORE-LIB-01`, `AGCORE-LIB-02`, `AGCORE-LIB-03`, `AGCORE-LIB-04`, `AGCORE-LIB-05` |
...
| 03-Agent-Runtime | `RT-INT-01`, `RT-INT-03`, `RT-LIB-02` |
| 17-Skill-SDK与离线开发 | `SDK-API-01`, `SDK-API-02`, `SDK-API-03`, `SDK-CLI-01`, `SDK-CLI-02`, `SDK-CLI-03`, `SDK-LIB-01`, `SDK-LIB-02` |
| 10-Channel-Gateway | `CH-API-01`, `CH-API-02`, `CH-API-03`, `CH-API-04`, `CH-API-05`, `CH-API-06`, `CH-API-07`, `CH-DATA-01`, `CH-DATA-02`, `CH-DATA-03`, `CH-DATA-04`, `CH-INT-01`, `CH-INT-02`, `CH-LIB-01`, `CH-LIB-02` |
...
| 07-Capability-Runtime | `CAP-API-01`, `CAP-API-02`, `CAP-API-03`, `CAP-API-04`, `CAP-API-05`, `CAP-API-07`, `CAP-API-06`, `CAP-LIB-01`, `CAP-LIB-02`, `CAP-LIB-03`, `CAP-LIB-04`, `CAP-LIB-05` |
| 16-Knowledge规划 | 无冻结接口 |
| 15-可观测性与Web公共基础 | `OPS-API-01`, `OPS-API-02`, `OPS-API-03`, `OPS-API-04`, `AUDIT-API-01` |
| 09-Auth与项目平台 | `PLAT-API-01`, `PLAT-API-02`, `PLAT-API-03`, `PLAT-API-04`, `PLAT-API-05`, `CRED-API-01`, `CRED-API-02`, `CRED-API-03`, `CRED-API-04`, `AUTH-API-01`, `AUTH-LIB-01`, `AUTH-LIB-02`, `AUTH-LIB-03` |
| 12-Project-Integration与Registry | `INT-LIB-01`, `INT-LIB-02`, `INT-LIB-03`, `INT-API-01` |
