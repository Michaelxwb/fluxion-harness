...
**原型被取代范围声明（T-34 / Z-01 / Z-13 / Z-15 / D1 / D2 / D4 / D5 / B11 / B13 / B14 / Z-02 / Z-04 / Z-06 / Z-07 / Z-08 / Z-09 / Z-10 / Z-11 / Z-14 / Y-08）**：`fluxion-console-interaction-prototype-v0.8-final.html` 的冻结时间早于 ADR-015 / ADR-021 等后续裁决，**不逐条回写该 HTML**。原型与下文冲突时视为过期载体，以 `90-Console交互规格.md` + 后端模块授权列为准。声明分**正反两向**，避免每轮评审重复发现同一批差异：
